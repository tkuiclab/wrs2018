...
class GetJointPoseResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.joint_value, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.joint_value = _arrayDeserializer.float64(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.joint_value.length;
    return length + 8;
  }
...
module.exports = {
  ...
  md5sum() { return 'a41e2236bf819259792cbf06540699bd'; },
  datatype() { return 'manipulator_h_base_module_msgs/GetJointPose'; }
};
